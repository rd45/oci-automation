...
Following this line of thinking one stage further - we could actually get rid of Terraform entirely, and instead use the oci-ansible-modules by themselves address OCI infrastructure & services. Two reasons why I'm not doing that here:
